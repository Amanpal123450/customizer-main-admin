...
export default function AdminPage() {
  ...
  const token = localStorage.getItem("adminToken");
        ...
        const res = await fetch("https://backend-customizer-1.onrender.com/api/v1/getAllUsers", {
          headers: {
  ...
  const token = localStorage.getItem("adminToken");
      ...
      const res = await fetch(` https://backend-customizer-1.onrender.com/api/v1/deleteUser/${id}`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`,
        },
