...
export default function Page() {
  ...
  useEffect(() => {
    const fetchAdmin = async () => {
      ...
      try {
        const res = await fetch(`https://ecomm-backend-7g4k.onrender.com/api/v1/getAdminById/${user}`, {
          headers: {
  ...
  const handleChange = (e: any) => {
    ...
    if (e.target.name === "profilePhoto") {
      ...
      setData((prev) => ({ ...prev, coverPhoto: url }));
    }
  };
      ...
      <div className="overflow-hidden rounded-[10px] bg-white shadow-1 dark:bg-gray-dark dark:shadow-card">
        <div className="relative z-20 h-35 md:h-65">
          ...
          <div className="absolute bottom-1 right-1 z-10 xsm:bottom-4 xsm:right-4">
            <label htmlFor="cover" className="flex cursor-pointer items-center justify-center gap-2 rounded-lg bg-primary px-[15px] py-[5px] text-body-sm font-medium text-white hover:bg-opacity-90">
              <input
                type="file"
                name="coverPhoto"
                id="coverPhoto"
          ...
          <div className="mt-4">
            ...
            <div className="mx-auto max-w-[720px]">
              ...
              <p className="mt-4">
                ...
                fermentum urna, eu condimentum mauris tempus ut.
              </p>
            </div>
