...
export default function CreateProduct() {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const res = await fetch("https://backend-customizer-1.onrender.com/api/v1/showAllCategory");
  ...
  useEffect(() => {
    const fetchVariants = async () => {
      try {
        const res = await fetch("https://backend-customizer-1.onrender.com/api/v1/totalVariation");
        const data = await res.json();
  ...
  useEffect(() => {
    const fetchBrands = async () => {
      try {
        const res = await fetch("https://backend-customizer-1.onrender.com/api/v1/totalBrands");
        const data = await res.json();
  ...
  useEffect(() => {
    const fetchUnits = async () => {
      try {
        const res = await fetch("https://backend-customizer-1.onrender.com/api/v1/totalUnit");
        const data = await res.json();
