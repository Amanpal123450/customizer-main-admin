    ...
    const fetchCategories = async () => {
      try {
        ...
        const res = await fetch(
          "https://backend-customizer-1.onrender.com/api/v1/showAllCategory",
        );
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      const [prodRes, subRes] = await Promise.all([
        fetch(`https://backend-customizer-1.onrender.com/api/v1/getProductsByCategoryId/${id}`),
        fetch(`https://backend-customizer-1.onrender.com/api/v1/fetchAllSubCategoryOfCategory/${id}`)
      ]);
      ...
      const res = await fetch(
        `https://backend-customizer-1.onrender.com/api/v1/deleteCategory/${id}`,
        {
          method: "DELETE",
          headers: {
