...
export default function TaxPage() {
  ...
  useEffect(() => {
    async function GetAllvariation() {
      const res = await fetch("https://backend-customizer.onrender.com/api/v1/totalTax", {
        method: "GET",
        headers: {
  ...
  const handleAddTax = async () => {
    ...
    try {
      const res = await fetch("https://backend-customizer.onrender.com/api/v1/addTax", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${token}`,
  ...
  const handleUpdateTax = async (id) => {
    ...
    try {
      const res = await fetch(
        `https://backend-customizer.onrender.com/api/v1/tax/${editId}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${token}`,
  ...
  if (confirmed) {
      try {
        const res = await fetch(`https://backend-customizer.onrender.com/api/v1/tax/${id}`, {
          method: "DELETE",
          headers: {
            "Authorization": `Bearer ${token}`
          }
  ...
  const toggleStatus = async (id) => {
    try {
      const response = await fetch(`https://backend-customizer.onrender.com/api/v1/TaxToggle/${id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          "Authorization":`Bearer ${token}`
